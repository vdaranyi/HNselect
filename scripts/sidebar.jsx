    ...
    render: function () {
        return <div className="sidebarbox">
            ...
            <div id="sidebarcontentarea"  className="container-fluid">
                ...
                <ContentArea data={this.props.data} />
            </div>
        </div>;
    }
            ...
            if (obj.type == "news") {
                return <div className="content-box">
                    <div className="content-title">
                        <h3 className="content-maintitle">{obj.title}</h3><h4 className="content-secondarytitle">({obj.url})</h4>
                    </div>
                    <div className="content-content">
                        <p className="content-text">{obj.text}</p>
                    </div>
                    <div className="content-footer"><p className="content-footertext">by {this.by} {timeToNow(this.timestamp)}</p></div>
                </div>;
            }
        })
    }
